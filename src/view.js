...
this.playfildInnerWidth = this.playfiledWidth - this.playfieldBorderWidth * 2;
this.playfildInnerHeight = this.playfiledHeight - this.playfieldBorderWidth * 2;

this.blockWidth = this.playfildInnerWidth/columns;
this.blockHeight = this.playfildInnerHeight/rows;

this.panelX = this.playfildInnerWidth + 10;
this.panelY = 0;
